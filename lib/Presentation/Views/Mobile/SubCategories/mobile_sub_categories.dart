...
class MobileSubCategoriesPage extends HookConsumerWidget {
          ...
          builder: (context, constraints) {
            ...
            return HookConsumer(
              builder: (context, ref, child) {
                ...
                Future<void> sendSubCateogry() async {
                  final categories =
                      ref.read(categoryResponseProvider).value ?? [];

                  final selectedCat = categories.firstWhere(
                    (c) => c.id == selectedfinal,
                  );
                          ...
                          children: [
                            ...
                            GlassmorphicContainer(
                              ...
                              child: Center(
                                child: Column(
                                  children: [
                                    SizedBox(height: width > 400 ? 100 : 35),
                                    Wrap(
                                      spacing: 25,
                                      runSpacing: 25,
                                    ...
                                    SizedBox(height: width > 400 ? 95 : 30),

                                    Wrap(
                                      spacing: width > 400 ? 30 : 25,
                                      runSpacing: 25,
                                      alignment: WrapAlignment.center,
                                      children: [
                                        ElevatedButton(
  ...
  Widget _mainContent(
    ...
    Animation<double> scaleAnimation,
    Animation<Color?> colorAnimation,
    List<SubcategoryModelResponse> subcategoryResult,
  ) {
    return Column(
      children: [
        Expanded(
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    children: [
                      ...
                      SizedBox(height: 25),
                      _allProductsSection(context, ref, subcategoryResult),
                      SizedBox(height: 25),
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: DataTable(
                          ...
                          rows: subcategoryResult.asMap().entries.map((entry) {
