...
class TabletHomePage extends HookConsumerWidget {
  ...
  Widget _welcomeSection(BuildContext context, WidgetRef ref) {
    final usernameResult = ref.watch(usernameProvider);
    return Row(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Expanded(
...
double _responsiveAddProduct(BuildContext context) {
  double screenWidth = MediaQuery.of(context).size.width;
